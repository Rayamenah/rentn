    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="check apartment description"
                />
                <meta
                    name="viewport"
            ...
            <section className='p-2 flex flex-col gap-3'>
                ...
                <aside className='flex flex-col gap-2'>
                    <div className='border border-gray-500 rounded-md'>
                        ...
                        <div className='p-2 flex gap-3 text-xs'>
                            <p>1 Bedroom</p>
                            |
                            <p>1 Toilet/bathroom</p>
                        </div>
                    </div>

                    <div className='border border-gray-500 rounded-md'>
                        <div className='bg-black text-white w-full p-2 py-2'>Details</div>
                        <p className='text-xs p-2'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita voluptatem sint quas molestias quo inventore aliquam vitae odit itaque saepe! Deserunt eius a ea ipsa explicabo distinctio quisquam eveniet ullam.</p>
                    </div>

                    <div className='bg-red-200 rounded-md p-2 py-2'>
                        <b>Safety Disclaimer</b>
                        <ul className="text-xs">
                            <li>Do not make any payment without seeing the agent or property</li>
                            <li>Ensure you meet the agent in a secure and open space</li>
                            <li>The agent does not represent Rent'n and Rent'n is not liable for any monetary trasaction between you and the agent</li>
                        </ul>
                    </div>
                </aside>
                ...
                <aside>
                    <div className='border border-gray-500 rounded-md'>
                        ...
                        <div className='p-2 py-2 gap-2'>
                            ...
                            <Link className='flex justify-center font-semibold underline' href=''>View Listings</Link>
                        </div>
                    </div>
                ...
                <aside className='border border-gray-500 rounded-md'>
                    ...
                    <div className='flex justify-center items-center'>
                        <button className='m-4 p-2 px-2 rounded-md bg-black text-white'>Show phone number</button>
                    </div>
                </aside>
                <br />
                <hr />
